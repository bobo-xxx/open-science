...
> 💡 **[Вышла AIPOCH Open-Science v0.31.1](https://github.com/aipoch/open-science/releases/latest)** _(последнее обновление: сентябрь 2026 г.)_. AIPOCH Open-Science v0.31.1 расширяет научные данные, доступные из сессии: инструменты ENA разрешают публичную акцессию ENA/INSDC в выполнения секвенирования со сгенерированными архивом файлами FASTQ, коннектор Genes получает обогащение по GO и биологическим путям на базе g:Profiler с настраиваемым статистическим фоном, а новые инструменты NCBI разрешают названия таксонов, позволяют просматривать версионированные сборки геномов и находить псевдонимы последовательностей. В настройках можно дополнительно подключить выделенную службу модели классификации, а сопряжение при удалённом доступе перемещается в начало панели безопасности с безопасным отзывом доверенных браузеров. Стабильность повышена по всем направлениям — Notebook с R в Windows наблюдают за постоянными ядрами и помогают восстановить сетевой доступ, потерянные сессии OpenCode восстанавливаются при запуске, а карточки разрешения, предпросмотры ожидающих сообщений и список недавних сессий работают надёжнее. Подробнее см. в [примечаниях к последнему выпуску](https://github.com/aipoch/open-science/releases/latest).

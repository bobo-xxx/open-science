...
> 💡 **[AIPOCH Open-Science v0.30.0 est disponible](https://github.com/aipoch/open-science/releases/latest)** _(dernière mise à jour : septembre 2026)_. AIPOCH Open-Science v0.30.0 fait de l'espace de travail le vôtre : des signets privés avec notes sur le texte de conversation, les aperçus et les passages de PDF ; des conversations latérales qui s'ouvrent en onglets d'aperçu indépendants pendant que la conversation principale reste active ; un centre de paramètres repensé avec navigation groupée et recherche étendue à l'ensemble des paramètres ; des filtres avancés pour la recherche globale ; et des agents qui peuvent désormais lire les figures, tableaux et algorithmes déjà extraits des PDF liés. Le travail en arrière-plan pendant les périodes d'inactivité est réduit, la récupération de la mise en page des PDF et la sélection de texte s'améliorent, et l'exactitude des connecteurs est renforcée pour dbSNP, VEP et BioMart. Consultez les [notes de version les plus récentes](https://github.com/aipoch/open-science/releases/latest) pour tous les détails.

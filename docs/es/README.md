...
> 💡 **[AIPOCH Open-Science v0.28.0 publicado](https://github.com/aipoch/open-science/releases/latest)** _(última actualización en septiembre de 2026)_. AIPOCH Open-Science v0.28.0 hace verificables los resultados capturados: reproduzca una versión de artefacto a partir de su receta sellada en un entorno aislado y compare los archivos reproducidos con el original mediante reglas de comparación byte a byte y científicas. Una búsqueda global categorizada alcanza proyectos, sesiones, cuerpos de mensajes, archivos cargados y generados, y la biblioteca de literatura, con vistas previas contextuales. Windows incorpora una vista previa opcional de Bash en WSL2, el entorno de ejecución de Codex gestionado ofrece actualizaciones probadas in situ, los medios remotos en la salida del modelo se cargan solo tras una activación explícita y los endpoints remotos de modelos deben usar HTTPS. Consulte las [notas de la versión más recientes](https://github.com/aipoch/open-science/releases/latest) para obtener todos los detalles.
...
| **Flujo de trabajo del agente**                        | Las sesiones en lenguaje natural ofrecen respuestas transmitidas y actividad de herramientas agrupada por finalidad, con controles de aprobación y detención, seguimientos en cola, compactación de contexto y recuperación tras reinicios. Ramifique el trabajo terminado en sesiones nuevas y use aclaraciones estructuradas, anotaciones de texto, imagen y PDF, contexto de lectura de PDF vinculados, memoria del proyecto, referencias de sesión y planes sujetos a revisión. Una búsqueda global categorizada alcanza proyectos, sesiones, cuerpos de mensajes, archivos cargados y generados, y la biblioteca de literatura, con filtros y vistas previas contextuales de detalle que saltan al mensaje coincidente. Las notificaciones, el estado en directo, los detalles de tiempo y tokens, la paleta de comandos, las vistas previas de fuentes y el cambio de proyecto mantienen visibles y manejables las investigaciones largas.                                                                                                    |
...
| **Habilidades científicas y conectores de datos**      | Amplíe los flujos de investigación con **22 habilidades integradas destacadas** y **24 conectores de investigación integrados**. Cree habilidades de forma conversacional o a partir de trabajo terminado, importe paquetes y fuentes de GitHub y añada conectores MCP locales o remotos personalizados con permisos por herramienta e importación/exportación de configuración. Las habilidades de aplicación centrales permanecen siempre habilitadas, de modo que los puntos de entrada integrados siguen funcionando, y la CLI sin interfaz gráfica y el Task SDK pueden listar, inspeccionar y habilitar o deshabilitar conectores. Las etiquetas entre recursos, una etiqueta protegida de Favoritos y los filtros con búsqueda organizan habilidades, conectores y especialistas.                                                                                                                                                                                                                                                            |

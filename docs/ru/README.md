...
> 💡 **[Вышла Open Science v0.19.0](https://github.com/aipoch/open-science/releases/latest)** _(последнее обновление: август 2026 г.)_. Open Science v0.19.0 добавляет провайдера подписки xAI (Grok) OAuth, управляемые установленные из маркетплейса специалисты, отслеживание зависимостей между запусками ноутбука с анализом tree-sitter, немедленную отправку посреди хода через нативное последующее управление, предварительный просмотр артефактов из Markdown в сообщениях, границы компрессии контекста в транскрипте, быстрый запуск с приоритетом сводки благодаря индексации метаданных сессий в SQLite, доступный только для чтения просмотр завершённых ноутбуков, переработанные разделы «О программе» и центр справки, горячую клавишу отмены архивирования, настраиваемые лимиты токенов моделей, полный жизненный цикл OAuth-коннекторов и модель deepseek-v4-flash-vision-exp; также объединены IPC-пакеты всплесков инструментов, пакетная обработка событий и исправлен широкий набор проблем ноутбуков, композера, рабочей области и провайдеров. Полный список изменений приведён в [примечаниях к последнему выпуску](https://github.com/aipoch/open-science/releases/latest).

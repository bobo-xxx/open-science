...
> 💡 **[AIPOCH Open-Science v0.29.0 publicado](https://github.com/aipoch/open-science/releases/latest)** _(última actualización en septiembre de 2026)_. AIPOCH Open-Science v0.29.0 hace que la investigación sea portátil y más rápida de encontrar e iniciar: un mercado verificado de habilidades con instalación en un clic y por lotes, paquetes de sesión `.science` autocontenidos que llevan consigo sus evidencias entre equipos, extracción local de figuras y tablas de PDF con exportación de tablas, e instalación de paquetes para entornos de ejecución de R propios con restauración condicional. La aplicación arranca notablemente más rápido, los conectores incorporan la gestión masiva y las búsquedas públicas por DOI, y la CLI sin interfaz gráfica añade el listado de entornos de ejecución, el arranque de Codex y la configuración de perfiles de terminal. Consulte las [notas de la versión más recientes](https://github.com/aipoch/open-science/releases/latest) para obtener todos los detalles.

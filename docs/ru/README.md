...
> 💡 **[Вышла AIPOCH Open-Science v0.26.0](https://github.com/aipoch/open-science/releases/latest)** _(последнее обновление: сентябрь 2026 г.)_. AIPOCH Open-Science v0.26.0 приносит вычисления уровня HPC и рабочее пространство для литературы: удалённые вычислительные узлы получают режим выполнения Slurm для каждого узла наряду с прямым подключением по SSH, а новая библиотека источников упорядочивает библиографические записи, PDF и цитаты — с импортом по идентификаторам, объединением дубликатов, прикреплением полных текстов из открытого доступа и оформлением цитат. Apodex присоединяется к встроенным поставщикам вместе с новейшими моделями OpenAI и Anthropic, вызовы инструментов Notebook становятся читаемыми сводными карточками, а по всему приложению появляются более плавная потоковая передача, менее навязчивые разрешения по умолчанию и широкий набор исправлений. Полный список изменений приведён в [примечаниях к последнему выпуску](https://github.com/aipoch/open-science/releases/latest).

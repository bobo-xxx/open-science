...
> 💡 **[Open Science v0.20.0 released](https://github.com/aipoch/open-science/releases/latest)** _(last updated August 2026)_. Open Science v0.20.0 connects sessions through `#` references that give an agent turn-scoped, read-only context. Side-chat advice can now reach a main turn while it is running, and long pasted text becomes a restorable attachment instead of overwhelming the composer. Bounded, indexed transcript rendering and progressive notebook history keep long sessions responsive, while denied permissions now remain enforced for the rest of the turn. See the [latest release notes](https://github.com/aipoch/open-science/releases/latest) for full details.

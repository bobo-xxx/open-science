...
> 💡 **[AIPOCH Open-Science v0.29.0 をリリースしました](https://github.com/aipoch/open-science/releases/latest)** _（最終更新：2026 年 9 月）_。AIPOCH Open-Science v0.29.0 は、研究を持ち運び可能にし、見つけて始めるまでを速くします。ワンクリックインストールと一括インストールに対応した検証済みスキルマーケットプレイス、証拠を伴ったままマシン間を移動できる自己完結型の `.science` セッションパッケージ、表エクスポート付きのローカル PDF 図表抽出、そして条件付きリストア付きの持ち込み R ランタイム向けパッケージインストールが加わりました。アプリの起動は明らかに速くなり、コネクタは一括管理と公開 DOI 検索に対応し、ヘッドレス CLI はランタイムの一覧表示、Codex の初回実行のブートストラップ、ターミナルプロファイルのセットアップに対応しました。詳細は[最新リリースノート](https://github.com/aipoch/open-science/releases/latest)を参照してください。
...
| 分野                                         | 主な機能                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
| -------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **プロジェクトとセッション**                 | プロジェクトを作成・整理し、セッションのピン留め、永続的なメッセージ分岐とサイド会話、編集可能なセッション詳細を利用できます。完了済みプロンプトを、元の後続経路を削除せずに永続的で選択可能なメッセージ分岐として編集し、最近の作業・下書き・会話履歴・プレビュー状態を復元できます。セッションを自己完結型の `.science` 研究パッケージとしてエクスポートし、会話ブランチ、ファイルバージョン、Notebook 記録、検証証拠を伴ったまま、別のプロジェクトやマシンへインポートできます。                                                                                                                                                                                                                                                                                                                                                                                                                                                                             |
| **エージェントワークフロー**                 | 自然言語セッションでストリーミング応答と目的別にまとめられたツール活動を確認し、承認・停止、フォローアップのキュー、コンテキスト圧縮、再起動後の復旧を利用できます。完了した作業を新しいセッションへ分岐し、構造化された確認、テキスト・画像・PDF 注釈、リンク済み PDF の読解コンテキスト、プロジェクトメモリ、セッション参照、レビュー必須の計画を組み合わせられます。カテゴリー別のグローバル検索は、プロジェクト、セッション、メッセージ本文、アップロード済みおよび生成済みファイル、文献ライブラリを対象とし、一致するメッセージへジャンプできる文脈付きの詳細プレビューとフィルターを備えます。通知、ライブ状態、時間とトークンの詳細、コマンドパレット、ソースプレビュー、プロジェクト切り替えにより、長時間の研究も可視化して管理できます。                                                                                                                                                                                                             |

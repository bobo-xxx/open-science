...
> 💡 **[Вышла Open Science v0.20.0](https://github.com/aipoch/open-science/releases/latest)** _(последнее обновление: август 2026 г.)_. Open Science v0.20.0 добавляет ссылки на сессии (`#`) в композере, внедрение советов из бокового чата в идущий основной ход, преобразование длинных вставок текста в восстанавливаемые вложения, прогресс установки пакетов в ноутбуке, поиск сессии по номеру в глобальном поиске, объединённую карточку сценариев моделей в настройках и упрощённый просмотр маркетплейса; вместе с этим — серьёзная работа над производительностью длинных сессий (ограниченный и индексированный рендеринг транскрипта, постепенная загрузка истории ноутбука, более быстрый запуск, кэшируемые панели использования), локализованные примечания к выпуску в диалоге обновления и большой список исправлений ноутбуков, рабочей области, провенанса, коннекторов и провайдеров. Полный список изменений приведён в [примечаниях к последнему выпуску](https://github.com/aipoch/open-science/releases/latest).

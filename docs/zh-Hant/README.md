...
> 💡 **[AIPOCH Open-Science v0.30.0 已發佈](https://github.com/aipoch/open-science/releases/latest)** _（最後更新於 2026 年 9 月）_。AIPOCH Open-Science v0.30.0 讓工作區真正屬於你：為對話文字、預覽與 PDF 段落加上可附註記的私人書籤；側聊以獨立預覽分頁開啟，主對話同時保持互動；重新設計的設定中心提供分組導覽與涵蓋所有設定的搜尋；全域搜尋新增進階篩選器；智能體現在也能讀取已從連結 PDF 擷取的圖、表與演算法。閒置時的背景工作減少，PDF 版面復原與文字選取獲得改善，dbSNP、VEP 與 BioMart 的連接器正確性也更加嚴謹。詳情請參閱[最新版本說明](https://github.com/aipoch/open-science/releases/latest)。
...
| 領域                           | 核心能力                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             |
| ------------------------------ | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **專案與會話**                 | 建立和組織專案，支援會話置頂、持久訊息分支和側邊對話以及可編輯會話詳情。可將已完成的提示編輯為持久、可選取的訊息分支，而不刪除原有後續路徑，並復原近期工作、草稿、對話歷史和預覽狀態。側聊以獨立預覽分頁開啟——可在仍可互動的主對話旁同時執行多個側聊，並在兩者之間搬移註解。可將會話匯出為自包含的 `.science` 研究套件，並匯入到另一個專案或機器——對話分支、檔案版本、Notebook 記錄與驗證證據都一併隨行。                                                                                                                                                                                                                                            |

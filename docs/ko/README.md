...
| **배포 및 지원**      | macOS, Windows, Linux 설치 프로그램, 환경·데이터 위치·에이전트 런타임·모델 제공업체·Notebook 런타임을 위한 간결한 최초 실행 마법사, 스페인어·프랑스어·중국어 간체·중국어 번체·일본어·한국어·러시아어 인터페이스, 지원 언어별 README 번역, 그 밖의 다국어 기여 가이드, 눈에 띄는 업데이트 알림이 포함된 업데이트 안내, 로컬 진단, 커뮤니티 링크.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |

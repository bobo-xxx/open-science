...
> 💡 **[AIPOCH Open-Science v0.29.0 veröffentlicht](https://github.com/aipoch/open-science/releases/latest)** _(zuletzt aktualisiert im September 2026)_. AIPOCH Open-Science v0.29.0 macht Forschung portabel und schneller auffindbar und startbar: ein verifizierter Fähigkeiten-Marktplatz mit Ein-Klick- und Stapelinstallation, in sich geschlossene `.science`-Sitzungspakete, die ihre Evidenz zwischen Rechnern mitnehmen, lokale Extraktion von Abbildungen und Tabellen aus PDFs mit Tabellenexport sowie Paketinstallation für eigene R-Laufzeiten mit bedingter Wiederherstellung. Die App startet spürbar schneller, Konnektoren erhalten Massenverwaltung und öffentliche DOI-Abfragen, und die kopflose CLI lernt Laufzeitauflistung, Codex-Ersteinrichtung und Terminalprofil-Einrichtung. Weitere Details finden Sie in den [neuesten Versionshinweisen](https://github.com/aipoch/open-science/releases/latest).

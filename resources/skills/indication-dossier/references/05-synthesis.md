...
_Sections 1-3_: Narrative prose with inline citations. Be specific with numbers
...
_Section 4_: Mix of prose and structured data. Include tables for endpoint
comparisons and trial parameters where helpful.

_Section 5_: Structured entries for each trial. Connect to lessons for
future trial design.

_Throughout_: Frame from the patient population perspective. Use the framing
guidance from SKILL.md.

_Figures_: Only generate a chart when it shows a relationship or

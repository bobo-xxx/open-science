...
> 💡 **[AIPOCH Open-Science v0.30.0 출시](https://github.com/aipoch/open-science/releases/latest)** _(마지막 업데이트: 2026년 9월)_. AIPOCH Open-Science v0.30.0은 워크스페이스를 자신만의 공간으로 만듭니다. 대화 텍스트, 미리보기, PDF 구절에 메모를 남길 수 있는 개인 북마크, 메인 대화가 활성 상태를 유지하는 가운데 독립적인 미리보기 탭으로 열리는 사이드 대화, 그룹화된 탐색과 설정 전체 검색을 갖춘 새로 디자인된 설정 센터, 전역 검색용 고급 필터, 그리고 연결된 PDF에서 이미 추출된 그림, 표, 알고리즘을 이제 읽을 수 있는 에이전트가 포함됩니다. 유휴 백그라운드 작업이 줄어들고, PDF 레이아웃 복원과 텍스트 선택이 개선되었으며, dbSNP, VEP, BioMart 전반에서 커넥터 정확성이 강화되었습니다. 자세한 내용은 [최신 릴리스 노트](https://github.com/aipoch/open-science/releases/latest)를 확인하세요.
...
| 영역                                         | 핵심 기능                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
| -------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **프로젝트와 세션**                          | 프로젝트를 만들고 정리하며, 세션 고정, 영구 메시지 분기와 사이드 대화, 편집 가능한 세션 세부 정보를 지원합니다. 완료된 프롬프트를 원래 후속 경로를 삭제하지 않고 영구적이고 선택 가능한 메시지 분기로 편집하고, 최근 작업·초안·대화 기록·미리보기 상태를 복구할 수 있습니다. 사이드 대화는 독립적인 미리보기 탭으로 열립니다 — 여전히 상호 작용 가능한 메인 대화와 나란히 여러 개를 실행하고 그 사이에서 주석을 옮길 수 있습니다. 세션을 자체 포함형 `.science` 연구 패키지로 내보내 다른 프로젝트나 컴퓨터로 가져올 수 있습니다 — 대화 분기, 파일 버전, Notebook 기록, 검증 증거가 함께 전달됩니다.                                                                                                                                                                                                                                                        |

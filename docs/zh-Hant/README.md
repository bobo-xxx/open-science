...
| **發佈與支援**     | macOS、Windows 及 Linux 安裝程式；針對環境、資料位置、智能體執行環境、模型服務商與 Notebook 執行環境的精簡首次啟動引導；支援西班牙文、法文、簡體中文、繁體中文、日文、韓文和俄文介面，為每種支援語言提供 README 譯本，另有多語言貢獻指南；具醒目更新提醒的更新指引；本地診斷；社群連結。                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |

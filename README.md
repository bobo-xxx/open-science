...
> 💡 **[Open Science v0.20.0 released](https://github.com/aipoch/open-science/releases/latest)** _(last updated August 2026)_. Open Science v0.20.0 adds session mentions (`#`) in the composer, side-chat advisories that reach a running main turn, long pasted text converted into restorable attachments, notebook package-installation progress, session-number lookup in global search, a consolidated Scenario models card in Settings, and streamlined Marketplace browsing — alongside major long-session performance work (bounded and indexed transcript rendering, progressive notebook history loading, faster startup, and cached usage panels), localized update-dialog release notes, and a long list of notebook, workspace, provenance, connector, and provider fixes. See the [latest release notes](https://github.com/aipoch/open-science/releases/latest) for full details.

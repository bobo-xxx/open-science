...
> 💡 **[Вышла AIPOCH Open-Science v0.29.0](https://github.com/aipoch/open-science/releases/latest)** _(последнее обновление: сентябрь 2026 г.)_. AIPOCH Open-Science v0.29.0 делает исследования переносимыми, а их поиск и запуск — более быстрыми: проверенный маркетплейс навыков с установкой в один клик и пакетной установкой, автономные пакеты сессий `.science`, переносящие свои свидетельства между компьютерами, локальное извлечение рисунков и таблиц из PDF с экспортом таблиц, а также установка пакетов для собственных сред выполнения R с условным восстановлением. Приложение заметно быстрее запускается, коннекторы получают массовое управление и публичный поиск метаданных по DOI, а автономный CLI умеет перечислять среды выполнения, выполнять первичную настройку Codex и инициализировать профили терминала. Полный список изменений приведён в [примечаниях к последнему выпуску](https://github.com/aipoch/open-science/releases/latest).
...
| --------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Проекты и сессии**                                            | Создавайте и организуйте проекты с закреплёнными сессиями, постоянными ветвями сообщений и боковыми обсуждениями, а также редактируемыми сведениями о сессии. Редактируйте завершённые запросы, превращая их в постоянные выбираемые ветви сообщений без удаления исходного последующего пути, и восстанавливайте недавнюю работу, черновики, историю обсуждений и состояние предварительного просмотра. Экспортируйте сессию как автономный исследовательский пакет `.science` и импортируйте его в другой проект или на другой компьютер — вместе с ветвями диалога, версиями файлов, записями Notebook и свидетельствами верификации.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
| **Рабочий процесс агента**                                      | Сессии на естественном языке поддерживают потоковые ответы, группировку действий инструментов по назначению, управление одобрением и остановкой, очередь последующих запросов, сжатие контекста и восстановление после перезапуска. Завершённую работу можно переносить в новые ветви сессий, используя структурированные уточнения, аннотации текста, изображений и PDF, контекст чтения связанных PDF, память проекта, ссылки на сессии и планы с обязательной проверкой. Категоризированный глобальный поиск охватывает проекты, сессии, тексты сообщений, загруженные и созданные файлы и библиотеку источников — с фильтрами, контекстными предпросмотрами подробных сведений и переходом к совпадающему сообщению. Уведомления, состояние в реальном времени, сведения о времени и токенах, палитра команд, предварительный просмотр источников и переключение проектов помогают контролировать длительные исследования.                                                                                                                                                                                                                  |

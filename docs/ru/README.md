...
> 💡 **[Вышла Open Science v0.20.0](https://github.com/aipoch/open-science/releases/latest)** _(последнее обновление: август 2026 г.)_. Open Science v0.20.0 связывает сессии с помощью ссылок на сессии (`#`), которые дают агенту ограниченный текущим ходом доступ к контексту только для чтения. Советы из бокового чата теперь могут поступать в основной ход во время его выполнения, а длинные вставки текста превращаются в восстанавливаемые вложения и не переполняют композер. Ограниченный и индексированный рендеринг транскрипта вместе с постепенной загрузкой истории Notebook сохраняют отзывчивость длинных сессий, а отказ в разрешении действует до конца хода. Полный список изменений приведён в [примечаниях к последнему выпуску](https://github.com/aipoch/open-science/releases/latest).

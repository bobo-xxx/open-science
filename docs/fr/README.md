...
> 💡 **[Open Science v0.20.0 est disponible](https://github.com/aipoch/open-science/releases/latest)** _(dernière mise à jour : août 2026)_. Open Science v0.20.0 relie les sessions grâce aux références de session (`#`), qui donnent à l'agent un contexte en lecture seule limité au tour en cours. Les recommandations issues des conversations latérales peuvent désormais atteindre le tour principal pendant son exécution, tandis que les longs collages de texte deviennent des pièces jointes restaurables au lieu d'encombrer le composeur. Le rendu borné et indexé de la transcription et le chargement progressif de l'historique du notebook préservent la réactivité des longues sessions, tandis qu'un refus d'autorisation reste appliqué jusqu'à la fin du tour. Consultez les [notes de version les plus récentes](https://github.com/aipoch/open-science/releases/latest) pour tous les détails.

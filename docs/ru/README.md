...
> 💡 **[Вышла AIPOCH Open-Science v0.33.2](https://github.com/aipoch/open-science/releases/latest)** _(обновлено в сентябре 2026)_. AIPOCH Open-Science v0.33.2 поставляется с установщиками Windows с кодовой подписью, поэтому предупреждение SmartScreen при первом запуске исчезло. Коннектор аннотации белков получает анализ обогащения белок-белковых взаимодействий STRING, предпросмотры браузера живых источников теперь сохраняются между посещениями, а делегирование удерживает завершённые результаты при сбоях очистки. Рабочий процесс Figure Composer обновлён, значки типов файлов появляются в заголовках предпросмотра, а загрузки ведут на официальную страницу загрузки. Подробности — в [последних заметках о выпуске](https://github.com/aipoch/open-science/releases/latest).

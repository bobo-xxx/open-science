...
> 💡 **[AIPOCH Open-Science v0.30.0 已发布](https://github.com/aipoch/open-science/releases/latest)** _（最后更新于 2026 年 9 月）_。AIPOCH Open-Science v0.30.0 让工作区真正属于你：可在会话文本、预览与 PDF 段落上添加带笔记的私有书签；侧聊以独立预览标签页打开，主对话同时保持活跃；重新设计的设置中心提供分组导航与覆盖全部设置的搜索；全局搜索新增高级筛选；智能体现在可以读取已从关联 PDF 中提取的图、表与算法。应用空闲时的后台工作减少，PDF 版面恢复与文本选择得到改进，dbSNP、VEP 与 BioMart 连接器的正确性进一步收紧。详情请查看[最新发行说明](https://github.com/aipoch/open-science/releases/latest)。
...
| 领域                           | 核心能力                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
| ------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **项目与会话**                 | 创建和组织项目，支持会话置顶、持久消息分支和侧边对话以及可编辑会话详情。可将已完成的提示编辑为持久、可选择的消息分支，而不删除原有后续路径，并恢复近期工作、草稿、对话历史和预览状态。侧聊以独立预览标签页打开——可在仍然可交互的主对话旁并行运行多个侧聊，并在其间移动批注。可将某个会话导出为自包含的 `.science` 研究包，并导入到其他项目或机器——对话分支、文件版本、Notebook 记录和验证证据都会随包携带。                                                                                                                                                                                                                                       |

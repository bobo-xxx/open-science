...
> 💡 **[Вышла AIPOCH Open-Science v0.32.0](https://github.com/aipoch/open-science/releases/latest)** _(последнее обновление: сентябрь 2026 г.)_. AIPOCH Open-Science v0.32.0 делает доказательные материалы PDF долговечными, а экспорт артефактов — совместимым: постоянные аннотации и Notebook, закреплённый за файлом, хранят стили текста, отметки областей, заметки, комментарии, цвета и теги вместе с той версией файла, к которой они относятся, с экспортом в аннотированные PDF или Markdown/CSV без изменения исходных байтов, а проверенные версии артефактов теперь упаковываются в полные архивы RO-Crate вместе со своими точными входными данными. Работа с последовательностями и омическими данными получает асинхронные поиски NCBI BLAST, поиск выполнений ENA с исходными переданными файлами, постраничные списки файлов проектов PRIDE и поиск белков UniProt по гену или организму. Установка локальных моделей разбора PDF больше не зависит от единственного источника загрузки благодаря проверенным зеркалам, выбор возможностей может указывать на собственную локально размещённую службу классификации, а фоновые выполнения в CLI можно полностью избавить от ожидания человека. Запуск и длинные диалоги работают быстрее благодаря пакетному восстановлению, отложенной работе с Markdown и сниженным накладным расходам наблюдателей. Подробнее см. в [примечаниях к последнему выпуску](https://github.com/aipoch/open-science/releases/latest).

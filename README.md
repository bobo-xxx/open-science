...
> 💡 **[AIPOCH Open-Science v0.29.0 released](https://github.com/aipoch/open-science/releases/latest)** _(last updated September 2026)_. AIPOCH Open-Science v0.29.0 makes research portable and faster to find and start: a verified skills marketplace with one-click and batch installation, self-contained `.science` session packages that carry their evidence between machines, local PDF figure-and-table extraction with table exports, and package installation for bring-your-own R runtimes with conditional restore. The app starts noticeably faster, connectors gain bulk management and public DOI lookups, and the headless CLI learns runtime listing, Codex bootstrap, and terminal profile setup. See the [latest release notes](https://github.com/aipoch/open-science/releases/latest) for full details.

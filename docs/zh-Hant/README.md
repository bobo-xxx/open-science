...
> 💡 **[Open Science v0.20.0 已發佈](https://github.com/aipoch/open-science/releases/latest)** _（最後更新於 2026 年 8 月）_。Open Science v0.20.0 新增撰寫器中的工作階段參照（`#`）、側邊對話建議注入正在執行的主回合、長文字貼上轉換為可還原的附件、筆記本套件安裝進度、全域搜尋的工作階段編號查找、設定中合併的情境模型卡片，以及更簡潔的市集瀏覽；同時帶來重要的長工作階段效能最佳化（有界且索引化的轉錄渲染、筆記本歷史漸進載入、更快的啟動、快取的用量面板）、本地化的更新彈窗版本說明，並修復大量筆記本、工作區、溯源、連接器與提供商問題。詳情請參閱[最新版本說明](https://github.com/aipoch/open-science/releases/latest)。

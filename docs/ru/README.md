...
> 💡 **[Вышла AIPOCH Open-Science v0.28.0](https://github.com/aipoch/open-science/releases/latest)** _(последнее обновление: сентябрь 2026 г.)_. AIPOCH Open-Science v0.28.0 делает зафиксированные результаты проверяемыми: воспроизведите версию артефакта по её запечатанному рецепту в изолированной среде и сравните повторно полученные файлы с исходными по правилам побайтово точного и научного сравнения. Категоризированный глобальный поиск охватывает проекты, сессии, тексты сообщений, загруженные и созданные файлы, а также библиотеку источников с контекстными предпросмотрами. Windows получает необязательное превью WSL2 Bash, управляемая среда выполнения Codex предлагает протестированные обновления на месте, удалённые медиа в выводе модели загружаются только после явной активации, а удалённые конечные точки моделей должны использовать HTTPS. Полный список изменений приведён в [примечаниях к последнему выпуску](https://github.com/aipoch/open-science/releases/latest).

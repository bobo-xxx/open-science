...
> 💡 **[AIPOCH Open-Science v0.30.0 publicado](https://github.com/aipoch/open-science/releases/latest)** _(última actualización en septiembre de 2026)_. AIPOCH Open-Science v0.30.0 hace suyo el espacio de trabajo: marcadores privados con notas sobre texto de conversación, vistas previas y pasajes de PDF; conversaciones laterales que se abren como pestañas de vista previa independientes mientras la conversación principal permanece activa; un centro de configuración rediseñado con navegación agrupada y búsqueda en toda la configuración; filtros avanzados para la búsqueda global; y agentes que ya pueden leer las figuras, tablas y algoritmos extraídos de los PDF vinculados. Se reduce el trabajo en segundo plano durante la inactividad, mejoran la recuperación del diseño de los PDF y la selección de texto, y se refuerza la corrección de los conectores en dbSNP, VEP y BioMart. Consulte las [notas de la versión más recientes](https://github.com/aipoch/open-science/releases/latest) para obtener todos los detalles.

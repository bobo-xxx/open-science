...
> 💡 **[AIPOCH Open-Science v0.30.0 をリリースしました](https://github.com/aipoch/open-science/releases/latest)** _（最終更新：2026 年 9 月）_。AIPOCH Open-Science v0.30.0 は、ワークスペースを自分のものにします。会話テキスト、プレビュー、PDF の箇所にメモを付けられるプライベートブックマーク、メイン会話を操作したまま独立したプレビュータブとして開くサイド会話、グループ化されたナビゲーションと設定横断検索を備えた再設計済みの設定センター、グローバル検索の詳細フィルター、そしてリンク済み PDF から抽出済みの図、表、アルゴリズムを読み取れるようになったエージェントが加わりました。アイドル時のバックグラウンド処理は削減され、PDF のレイアウト復元とテキスト選択が改善され、dbSNP、VEP、BioMart でコネクタの正確性が強化されました。詳細は[最新リリースノート](https://github.com/aipoch/open-science/releases/latest)を参照してください。
...
| 分野                                         | 主な機能                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
| -------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **プロジェクトとセッション**                 | プロジェクトを作成・整理し、セッションのピン留め、永続的なメッセージ分岐とサイド会話、編集可能なセッション詳細を利用できます。完了済みプロンプトを、元の後続経路を削除せずに永続的で選択可能なメッセージ分岐として編集し、最近の作業・下書き・会話履歴・プレビュー状態を復元できます。サイド会話は独立したプレビュータブとして開き、操作可能なままのメイン会話と並行して複数を実行し、注釈をそれらの間で移動できます。セッションを自己完結型の `.science` 研究パッケージとしてエクスポートし、会話ブランチ、ファイルバージョン、Notebook 記録、検証証拠を伴ったまま、別のプロジェクトやマシンへインポートできます。                                                                                                                                                                                                                                                                                                                                             |

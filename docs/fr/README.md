...
> 💡 **[Open Science v0.20.0 est disponible](https://github.com/aipoch/open-science/releases/latest)** _(dernière mise à jour : août 2026)_. Open Science v0.20.0 ajoute les références de session (`#`) dans le composeur, l'injection de recommandations des conversations latérales dans un tour principal en cours, la conversion des longs collage de texte en pièces jointes restaurables, la progression d'installation des paquets du notebook, la recherche de session par numéro dans la recherche globale, une carte Scénarios de modèles consolidée dans les paramètres et une navigation de place de marché simplifiée ; en parallèle, d'importants travaux de performance pour les longues sessions (rendu de transcription borné et indexé, chargement progressif de l'historique du notebook, démarrage plus rapide, panneaux d'utilisation en cache), des notes de version localisées dans le dialogue de mise à jour, et une longue liste de correctifs de notebook, d'espace de travail, de provenance, de connecteurs et de fournisseurs. Consultez les [notes de version les plus récentes](https://github.com/aipoch/open-science/releases/latest) pour tous les détails.

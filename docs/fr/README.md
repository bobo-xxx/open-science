...
> 💡 **[AIPOCH Open-Science v0.29.0 est disponible](https://github.com/aipoch/open-science/releases/latest)** _(dernière mise à jour : septembre 2026)_. AIPOCH Open-Science v0.29.0 rend la recherche portable et plus rapide à trouver et à démarrer : une place de marché vérifiée de compétences avec installation en un clic et par lots, des paquets de session `.science` autonomes qui transportent leurs preuves d'une machine à l'autre, l'extraction locale des figures et des tableaux des PDF avec exportation des tableaux, et l'installation de paquets pour les environnements d'exécution R externes avec restauration conditionnelle. L'application démarre nettement plus vite, les connecteurs gagnent la gestion en masse et les recherches publiques par DOI, et le CLI headless sait désormais lister les environnements d'exécution, amorcer Codex et configurer les profils de terminal. Consultez les [notes de version les plus récentes](https://github.com/aipoch/open-science/releases/latest) pour tous les détails.

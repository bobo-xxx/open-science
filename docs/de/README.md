...
> 💡 **[AIPOCH Open-Science v0.28.0 veröffentlicht](https://github.com/aipoch/open-science/releases/latest)** _(zuletzt aktualisiert im September 2026)_. AIPOCH Open-Science v0.28.0 macht erfasste Ergebnisse überprüfbar: Spielen Sie eine Artefaktversion anhand ihres versiegelten Rezepts in einer isolierten Umgebung erneut ab und vergleichen Sie die reproduzierten Dateien über byte-genaue und wissenschaftliche Vergleichsregeln mit dem Original. Eine kategorisierte globale Suche erreicht Projekte, Sitzungen, Nachrichtentexte, hochgeladene und erzeugte Dateien sowie die Literaturbibliothek mit kontextbezogenen Vorschauen. Windows erhält eine optionale WSL2-Bash-Vorschau, die verwaltete Codex-Laufzeit bietet getestete Upgrades ohne Neuinstallation, externe Medien in Modellausgaben werden erst nach ausdrücklicher Aktivierung geladen, und entfernte Modell-Endpunkte müssen HTTPS verwenden. Weitere Details finden Sie in den [neuesten Versionshinweisen](https://github.com/aipoch/open-science/releases/latest).

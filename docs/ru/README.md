...
> 💡 **[Вышла AIPOCH Open-Science v0.30.0](https://github.com/aipoch/open-science/releases/latest)** _(последнее обновление: сентябрь 2026 г.)_. AIPOCH Open-Science v0.30.0 делает рабочее пространство по-настоящему вашим: приватные закладки с заметками к тексту беседы, предпросмотрам и фрагментам PDF; боковые обсуждения, открывающиеся как независимые вкладки предпросмотра, пока главный диалог остаётся активным; переработанный центр настроек со сгруппированной навигацией и поиском по всем настройкам; расширенные фильтры глобального поиска; а также агенты, которые теперь могут читать уже извлечённые из связанных PDF рисунки, таблицы и алгоритмы. Сокращена фоновая работа во время простоя, улучшены восстановление макета PDF и выделение текста, а корректность коннекторов усилена для dbSNP, VEP и BioMart. Полный список изменений приведён в [примечаниях к последнему выпуску](https://github.com/aipoch/open-science/releases/latest).
...
| --------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Проекты и сессии**                                            | Создавайте и организуйте проекты с закреплёнными сессиями, постоянными ветвями сообщений и боковыми обсуждениями, а также редактируемыми сведениями о сессии. Редактируйте завершённые запросы, превращая их в постоянные выбираемые ветви сообщений без удаления исходного последующего пути, и восстанавливайте недавнюю работу, черновики, историю обсуждений и состояние предварительного просмотра. Боковые обсуждения открываются как независимые вкладки предпросмотра — запускайте несколько одновременно, пока главный диалог остаётся полностью активным, и переносите аннотации между ними. Экспортируйте сессию как автономный исследовательский пакет `.science` и импортируйте его в другой проект или на другой компьютер — вместе с ветвями диалога, версиями файлов, записями Notebook и свидетельствами верификации.                                                                                                                                                                                                                                                                                                          |

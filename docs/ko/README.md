...
> 💡 **[AIPOCH Open-Science v0.29.0 출시](https://github.com/aipoch/open-science/releases/latest)** _(마지막 업데이트: 2026년 9월)_. AIPOCH Open-Science v0.29.0은 연구를 휴대할 수 있게 하고 더 빠르게 찾고 시작할 수 있게 만듭니다. 원클릭 및 일괄 설치를 갖춘 검증된 스킬 마켓플레이스, 증거를 컴퓨터 사이에서 함께 가져가는 자체 포함형 `.science` 세션 패키지, 표 내보내기가 함께 제공되는 로컬 PDF 그림·표 추출, 조건부 복원을 지원하는 직접 준비한 R 런타임용 패키지 설치가 포함됩니다. 앱이 눈에 띄게 빠르게 시작되고, 커넥터는 일괄 관리와 공개 DOI 조회 기능을 얻으며, 헤드리스 CLI는 런타임 나열, Codex 부트스트랩, 터미널 프로필 설정을 지원합니다. 자세한 내용은 [최신 릴리스 노트](https://github.com/aipoch/open-science/releases/latest)를 확인하세요.
...
| 영역                                         | 핵심 기능                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
| -------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **프로젝트와 세션**                          | 프로젝트를 만들고 정리하며, 세션 고정, 영구 메시지 분기와 사이드 대화, 편집 가능한 세션 세부 정보를 지원합니다. 완료된 프롬프트를 원래 후속 경로를 삭제하지 않고 영구적이고 선택 가능한 메시지 분기로 편집하고, 최근 작업·초안·대화 기록·미리보기 상태를 복구할 수 있습니다. 세션을 자체 포함형 `.science` 연구 패키지로 내보내 다른 프로젝트나 컴퓨터로 가져올 수 있습니다 — 대화 분기, 파일 버전, Notebook 기록, 검증 증거가 함께 전달됩니다.                                                                                                                                                                                                                                                                                                                                                                                                             |
| **에이전트 워크플로**                        | 자연어 세션에서 스트리밍 응답과 목적별로 그룹화된 도구 활동을 확인하고 승인·중지 제어, 후속 작업 대기열, 컨텍스트 압축, 재시작 복구를 사용할 수 있습니다. 완료된 작업을 새 세션으로 분기하고 구조화된 확인, 텍스트·이미지·PDF 주석, 연결된 PDF 읽기 컨텍스트, 프로젝트 메모리, 세션 참조, 검토가 필요한 계획을 결합할 수 있습니다. 분류별 전역 검색은 필터와 일치하는 메시지로 바로 이동하는 컨텍스트 상세 미리보기와 함께 프로젝트, 세션, 메시지 본문, 업로드 및 생성 파일, 문헌 라이브러리를 아우릅니다. 알림, 실시간 상태, 시간과 토큰 세부 정보, 명령 팔레트, 소스 미리보기, 프로젝트 전환으로 장시간 연구를 계속 확인하고 관리할 수 있습니다.                                                                                                                                                                                                          |
